      ...
      <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed">
            မြန်မာပြည်သူပြည်သားတို့၏ စိတ်ချမ်းသာစွာအသုံးပြုနိုင်မည့်
            ဘက်စုံကုန်ပစ္စည်းဆိုင်အဖြစ်အသိအမှတ်ပြုမူထက် အမိန့်အာမခံချက်ပါ
            စည်းမျဉ်းစည်းကမ်းတွင် တိကျမှန်ကန်စွာ အမြဲတမ်းကပ်လျက်ဆောင်ရွက်နေပါရစေ
            ခင်မင်ပါ၏။
          </p>
        </div>
